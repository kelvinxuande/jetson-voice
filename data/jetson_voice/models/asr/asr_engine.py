...
class ASREngine(ASRService):
    ...
    def __init__(self, config, *args, **kwargs):
        ...
        print("[jetson_voice/models/asr/asr_engine.py] Finished installing new configs for streaming, preprocessor, ctc_decoder")
        print("[jetson_voice/models/asr/asr_engine.py] Newly added configs for streaming:")
        print(self.config['streaming'])
        print("[jetson_voice/models/asr/asr_engine.py] Newly added configs for preprocessor:")
        print(self.config['preprocessor'])
        print("[jetson_voice/models/asr/asr_engine.py] Newly added configs for ctc_decoder:")
        print(self.config['ctc_decoder'])

        # create preprocessor instance
        print("[jetson_voice/models/asr/asr_engine.py] Creating preprocessor instance in resource.py")
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] preprocessor_name: {preprocessor_name}, of type: {type(preprocessor_name)}")
        print(f"[jetson_voice/models/asr/asr_engine.py] preprocessor_class: {preprocessor_class}, of type: {type(preprocessor_class)}; where preprocessor_class = getattr(importlib.import_module(preprocessor_name[0]), preprocessor_name[1])")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.preprocessor: {self.preprocessor}, of type: {type(self.preprocessor)}")

        # load the model
        print("[jetson_voice/models/asr/asr_engine.py] Loading model instance in resource.py")
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] Loaded model instance in resource.py with config and dynamic_shapes: {dynamic_shapes}, of type: {type(dynamic_shapes)}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.model: {self.model}, of type: {type(self.model)}")

        # create CTC decoder
        print("[jetson_voice/models/asr/asr_engine.py] Creating CTC decoder in resource.py")
        if not self.classification:
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] Creating CTC decoder in resource.py: {self.ctc_decoder}, of type: {self.ctc_decoder.type}")

        # create streaming buffer
        print("[jetson_voice/models/asr/asr_engine.py] Creating streaming buffer in resource.py")
        ...
        print("[jetson_voice/models/asr/asr_engine.py] Streaming buffer created in resource.py:")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.n_frame_len: {self.n_frame_len}, type: {self.n_frame_len}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.n_frame_overlap: {self.n_frame_overlap}, type: {self.n_frame_overlap}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.buffer_length: {self.buffer_length}, type: {self.buffer_length}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.buffer_duration: {self.buffer_duration}, type: {self.buffer_duration}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.buffer: {self.buffer}, type: {self.buffer}")
    ...
    def __call__(self, samples):
        ...
        """
        print(f"[jetson_voice/models/asr/asr_engine.py] Calling 'forward' pass via __call__")

        samples = audio_to_float(samples)

        print(f"[jetson_voice/models/asr/asr_engine.py] Overlapping frames...")

        if len(samples) < self.n_frame_len:
            print("[jetson_voice/models/asr/asr_engine.py] len(samples) < self.n_frame_len, padding samples with zeros")
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] Applying preprocessing...")
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] Running asr model...")
        try:
            print(f"[jetson_voice/models/asr/asr_engine.py] (input) preprocessed_signal of shape: {preprocessed_signal.shape}")
        except:
            print(f"[jetson_voice/models/asr/asr_engine.py] preprocessed_signal.shape failed")
            print(f"[jetson_voice/models/asr/asr_engine.py] (input) preprocessed_signal of length: {len(preprocessed_signal)}")
        print(f"[jetson_voice/models/asr/asr_engine.py] (input) preprocessed_signal of type: {type(preprocessed_signal)}")
        ...
        try:
            print(f"[jetson_voice/models/asr/asr_engine.py] (output) logits of shape: {logits.shape}")
        except:
            print(f"[jetson_voice/models/asr/asr_engine.py] logits.shape failed")
            print(f"[jetson_voice/models/asr/asr_engine.py] (output) logits of length: {len(logits)}")
        print(f"[jetson_voice/models/asr/asr_engine.py] (output) logits of type: {type(logits)}")
        ...
        print(f"[jetson_voice/models/asr/asr_engine.py] self.buffer_duration:{self.buffer_duration}, self.frame_length:{self.frame_length}, self.frame_overlap:{self.frame_overlap}")
        print(f"[jetson_voice/models/asr/asr_engine.py] self.timestep_duration:{self.timestep_duration}, self.n_timesteps_frame:{self.n_timesteps_frame}, self.n_timesteps_overlap:{self.n_timesteps_overlap}")
        ...
        if self.classification:
            ...
            print(f"[jetson_voice/models/asr/asr_engine.py] setting ctc_decoder set_timestep_duration as self.timestep_duration:{self.timestep_duration}")
            print(f"[jetson_voice/models/asr/asr_engine.py] setting ctc_decoder set_timestep_delta as self.n_timesteps_frame:{self.n_timesteps_frame}")
            ...
            print(f"[jetson_voice/models/asr/asr_engine.py] Finished ctc_decoding, returning transcripts:")
            print(f"[jetson_voice/models/asr/asr_engine.py] Transcripts: {transcripts}")
            print(f"[jetson_voice/models/asr/asr_engine.py] Transcripts length: {len(transcripts)}")
            print(f"[jetson_voice/models/asr/asr_engine.py] Transcripts of type: {type(transcripts)}")

            print(f"[jetson_voice/models/asr/asr_engine.py] Finished 'forward' pass via __call__")            
            return transcripts
