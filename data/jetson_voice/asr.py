...
def ASR(resource, *args, **kwargs):
    ...
    """
    print("[jetson_voice/asr.py] Loading a streaming ASR service or model")
    factory_map = {
    ...
    # return .json as a configdict object (config that watches and updates)
    print(f"[jetson_voice/asr.py>jetson_voice/utils/resource.py] Passing resource of type: {type(resource)} and factory_map of type: {type(factory_map)} to load_resource")
