if __name__ == "__main__":
    ...
    # asr_model = nemo_asr.models.EncDecCTCModel.restore_from('stt_en_citrinet_512_gamma_0_25.nemo', strict=False)
    # asr_model = nemo_asr.models.EncDecCTCModelBPE.restore_from('stt_en_citrinet_512_gamma_0_25.nemo', strict=False)
    ...
    model_types = {
        ...
        'asr' : nemo_asr.models.EncDecCTCModel, 
        # 'asr' : nemo_asr.models.EncDecCTCModelBPE, 
    ...
    if extension == '.nemo':
        model = model_types[args.type].restore_from(args.model, strict=False)
    elif extension == '.ckpt':
